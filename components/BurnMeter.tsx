...
const BurnMeter: React.FC<BurnMeterProps> = ({ sugarGrams }) => {
  ...
  return (
    <div className="mt-4 bg-white dark:bg-zinc-900 rounded-2xl p-4 border border-zinc-200 dark:border-zinc-800 shadow-sm">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-xs font-bold uppercase tracking-wider text-zinc-600 dark:text-zinc-400">The Physical Cost</span>
      </div>

      <div className="grid grid-cols-3 gap-2">
        {/* Walking */}
        <div className="flex flex-col items-center justify-center bg-zinc-50 dark:bg-zinc-900 p-2 rounded-xl border border-zinc-100 dark:border-zinc-800 dark:border-zinc-800 shadow-sm">
        ...
        {/* Running */}
        <div className="flex flex-col items-center justify-center bg-zinc-50 dark:bg-zinc-900 p-2 rounded-xl border border-zinc-100 dark:border-zinc-800 dark:border-zinc-800 shadow-sm relative overflow-hidden">
           {runningMins > 20 && <div className="absolute top-0 right-0 w-2 h-2 bg-rose-500 rounded-full animate-pulse mr-1 mt-1"></div>}
           <span className="text-xl mb-1">ðŸƒ</span>
