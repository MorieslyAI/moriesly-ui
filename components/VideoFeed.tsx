          ...
          {!hideScanModes && hasVisualContent && !isProcessing && (
              <div className="flex items-center gap-8 pointer-events-auto animate-in slide-in-from-bottom-2 duration-300">
                  ...
                  <button 
                    ...
                    className="group relative w-20 h-20 rounded-full border-4 border-white/80 flex items-center justify-center bg-transparent transition-all active:scale-95 shadow-[0_0_20px_rgba(255,255,255,0.3)]"
                  >
                      <div className="w-16 h-16 rounded-full bg-white group-hover:bg-zinc-200 transition-colors shadow-inner"></div>
